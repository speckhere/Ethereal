...
The project is using [Unity YYYY.M.DD]() and you can install it from the
[Unity Hub](https://unity.com/download) or

  * Window users can use [chocolatey](https://chocolatey.org) to install [Unity](https://community.chocolatey.org/packages/unity)
  * MacOS users can uses [brew](https://brew.sh) to install [Unity](https://formulae.brew.sh/cask/unity#default)
...
You will need to have [Discord](https://discord.com/download) installed on your computer or
  ...
  * MacOS users can uses [brew](https://brew.sh) to install [Discord](https://formulae.brew.sh/cask/discord#default)
...
You will need a text editor and we recommend [Visual Studio Code](https://code.visualstudio.com/download) or
  ...
  * MacOS users can uses [brew](https://brew.sh) to install [Visual Studio Code](https://formulae.brew.sh/cask/visual-studio-code#default)
